...
class PlayerTracker:
    ...
    def write_detection_record(self, frame_index, players_record, ball_image_position, detect_frame_count, fusion=None):
        ...
        if fusion is not None:
            record["shuttlecock"]["fusion"] = fusion
        self.detection_writer.write(record)

    def update(self, frame_index, centroids, ball_image_position, left_hand_positions, right_hand_positions, detect_frame_count, fusion=None):
        ...
        self.write_detection_record(frame_index, players_record, ball_image_position, detect_frame_count, fusion)
        return self.players
